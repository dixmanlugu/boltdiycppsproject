// /src/components/forms/225DecisionChiefCommissionerApprovedDeath.tsx
...
import { downloadConsentOfAwardDeath } from '../../utils/ConsentOfAward-Death';
...
const Decision225ChiefCommissionerApprovedDeath: React.FC<Props> = ({
  IRN,
  irn,
  onCloseAll,
}) => {
  ...
  // decision ui (kept but not rendered)
  ...
  // try to lock the record when the form opens (use commissioners review table)
  useEffect(() => {
    (async () => {
  ...
  const handlePreviewPdf = async () => {
    ...
    await downloadConsentOfAwardDeath(resolvedIRN, {
      crestUrl:
  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      if (decision === 'Approved') {
        ...
        // Download final PDF (Death) with the correct stamp & signature
        const crestUrl =
          'https://ennhknwwfdlaudephyly.supabase.co/storage/v1/object/public/cpps/logocrest.png';

        const stampUrl = isChief
          ? 'https://ennhknwwfdlaudephyly.supabase.co/storage/v1/object/sign/cpps/Commissionstamp.png?token=eyJraWQiOiJzdG9yZWdlLXVybC1zaWduaW5nLWtleV8xMmRkZDBlOC05MjU4LTQ5ZmEtYTUyYy03NmRlZDY5MTM4OTAiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJjcHBzL0NvbW1pc3Npb25zdGFtcC5wbmciLCJpYXQiOjE3NTQxNTA3MDIsImV4cCI6MjA2OTUxMDcwMn0.ET2gqM5ln9zbJbb5jH1gMHFz42HazTIoQ5s-BaUlADU'
          : 'https://ennhknwwfdlaudephyly.supabase.co/storage/v1/object/sign/cpps/Commissionstamp.png?token=eyJraWQiOiJzdG9yZWdlLXVybC1zaWduaW5nLWtleV8xMmRkZDBlOC05MjU4LTQ5ZmEtYTUyYy03NmRlZDY5MTM4OTAiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJjcHBzL0NvbW1pc3Npb25zdGFtcC5wbmciLCJpYXQiOjE3NTQxNTA3MDIsImV4cCI6MjA2OTUxMDcwMn0.ET2gqM5ln9zbJbb5jH1gMHFz42HazTIoQ5s-BaUlADU';

        const signatureUrl = isChief
          ? 'https://ennhknwwfdlaudephyly.supabase.co/storage/v1/object/sign/cpps/Comsignature.png?token=eyJraWQiOiJzdG9yZWdlLXVybC1zaWduaW5nLWtleV8xMmRkZDBlOC05MjU4LTQ5ZmEtYTUyYy03NmRlZDY5MTM4OTAiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJjcHBzL0NvbXNpZ25hdHVyZS5wbmciLCJpYXQiOjE3NTQxNTA4ODAsImV4cCI6MjA2OTUxMDg4MH0.R4wqJdga2M1RJZ1uxxG_0VgeFd-66fHIT9sscQGgYeE'
          : 'https://ennhknwwfdlaudephyly.supabase.co/storage/v1/object/sign/cpps/Comsignature.png?token=eyJraWQiOiJzdG9yZWdlLXVybC1zaWduaW5nLWtleV8xMmRkZDBlOC05MjU4LTQ5ZmEtYTUyYy03NmRlZDY5MTM4OTAiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJjcHBzL0NvbXNpZ25hdHVyZS5wbmciLCJpYXQiOjE3NTQxNTA4ODAsImV4cCI6MjA2OTUxMDg4MH0.R4wqJdga2M1RJZ1uxxG_0VgeFd-66fHIT9sscQGgYeE';
  ...
  return (
    <div className="fixed inset-0 z-[60]">
        ...
        <div className="bg-white rounded-lg shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center gap-3">
              <h2 className="text-lg font-semibold text-gray-900">
                Chief Commissioner Review — Death
              </h2>
              {resolvedIRN && (
          ...
          <div className="p-6 space-y-8 overflow-y-auto">
            ...
            <section className="border rounded-lg p-4">
              <h3 className="text-lg font-semibold mb-4 text-primary">Form 124 — Death Claim Detail</h3>
              {resolvedIRN ? (
                <Form124View
                  irn={resolvedIRN}
                  variant="embedded"
            ...
            <section className="border rounded-lg p-4 bg-amber-50">
              ...
              <div className="flex items-center gap-2 text-sm">
                <span>Generate Consent Of Award Certificate for Death Case :</span>
                <button
                  type="button"
            ...
            {/* ⛔️ Decision section removed for the Approved view */}
          </div>
      ...
      {/* Confirmation modal kept but unreachable without Decision UI */}
      {confirmOpen && (
...
export default Decision225ChiefCommissionerApprovedDeath;
