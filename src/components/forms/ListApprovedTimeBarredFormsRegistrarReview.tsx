...
interface ListApprovedTimeBarredFormsRegistrarReviewProps {
  onClose: () => void;
...
const ListApprovedTimeBarredFormsRegistrarReview: React.FC<ListApprovedTimeBarredFormsRegistrarReviewProps> = ({ 
  onClose,
  onSelectIRN 
}) => {
  ...
  const handleReview = (irn: string, tbcrrid: string, formType: string) => {
    if (onSelectIRN) {
      ...
      switch (formType) {
        case 'Form11':
          url = '/dashboard/timebarred/form11-approved';
          break;
        case 'Form12':
          url = '/dashboard/timebarred/form12-approved';
          break;
        default:
          url = '/dashboard/timebarred/approved';
      }
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-600">No Approved Forms For Reviews.</p>
            </div>
          )}
...
export default ListApprovedTimeBarredFormsRegistrarReview;
