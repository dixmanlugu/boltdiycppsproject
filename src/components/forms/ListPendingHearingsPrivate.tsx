...
const ListPendingHearingsPrivate: React.FC<ListPendingHearingsPrivateProps> = ({ 
  onClose,
  onSelectIRN 
}) => {
  ...
  const fetchHearingsList = async () => {
    try {
      ...
      let countQuery = supabase
        ...
        .eq('THSWorkerOrganizationType', 'Private');
      ...
      const { data, error } = await supabase
        .rpc('get_pending_hearings_private', {
...
export default ListPendingHearingsPrivate;
