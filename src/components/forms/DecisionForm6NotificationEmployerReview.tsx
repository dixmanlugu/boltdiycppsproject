import React, { useState, useEffect } from 'react';
    ...
    const DecisionForm6NotificationEmployerReview: React.FC = () => {
          ...
          const fetchFormData = async () => {
            try {
              ...
              const { data: processedData, error: processedError } = await supabase
                .from('form6notificationemployerreview')
                .select('is_processed')
                .eq('claim_id', router.query.claim_id)
                .single();
      ...
      return (
        <div className="bg-surface p-8 rounded-lg shadow-md max-w-2xl mx-auto">
          <h1 className="text-3xl font-bold mb-6 text-primary">Form6 Notification Employer Review</h1>
    ...
    export default DecisionForm6NotificationEmployerReview;
