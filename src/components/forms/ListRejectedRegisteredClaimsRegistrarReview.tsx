...
const ListRejectedRegisteredClaimsRegistrarReview: React.FC<ListRejectedRegisteredClaimsRegistrarReviewProps> = ({ 
  ...
  const fetchClaimsList = async () => {
    try {
      ...
      // Use the registrar_rejected_view for a cleaner query
  ...
  const handleView = (irn: string, rrid: string, incidentType: string) => {
    if (onSelectIRN) {
      ...
      switch (incidentType) {
        case 'Injury':
          url = '/dashboard/registrar/injury-rejected';
          break;
        case 'Death':
          url = '/dashboard/registrar/death-rejected';
          break;
      }
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-600">No Rejected Forms For Review.</p>
            </div>
          )}
