// /src/components/forms/322RejectedCompensationCalculationCPMReviewDeath.tsx
...
interface Form322RejectedCompensationCalculationCPMReviewDeathProps {
  IRN?: string;
  irn?: string;
  onCloseAll?: (refresh?: boolean) => void;
}

const Form322RejectedCompensationCalculationCPMReviewDeath: React.FC<
  Form322RejectedCompensationCalculationCPMReviewDeathProps
> = ({ IRN, irn, onCloseAll }) => {
          ...
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center gap-3">
              <h2 className="text-lg font-semibold text-gray-900">
                Compensation Calculation — CPM Review (Death) — Rejected
              </h2>
              {displayIRN && (
...
export default Form322RejectedCompensationCalculationCPMReviewDeath;
