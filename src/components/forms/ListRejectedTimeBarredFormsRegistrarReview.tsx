...
interface ListRejectedTimeBarredFormsRegistrarReviewProps {
  onClose: () => void;
...
const ListRejectedTimeBarredFormsRegistrarReview: React.FC<ListRejectedTimeBarredFormsRegistrarReviewProps> = ({ 
  onClose,
  onSelectIRN 
}) => {
  ...
  const handleReview = (irn: string, tbcrrid: string, formType: string) => {
    if (onSelectIRN) {
      ...
      switch (formType) {
        case 'Form11':
          url = '/dashboard/timebarred/form11-rejected';
          break;
        case 'Form12':
          url = '/dashboard/timebarred/form12-rejected';
          break;
        default:
          url = '/dashboard/timebarred/rejected';
      }
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-600">No Rejected Forms For Reviews.</p>
            </div>
          )}
...
export default ListRejectedTimeBarredFormsRegistrarReview;
