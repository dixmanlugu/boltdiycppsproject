// /src/components/forms/323ApprovedCompensationCalculationCPMReviewInjury.tsx
...
interface Form323ApprovedCompensationCalculationCPMReviewInjuryProps {
  IRN?: string;                          // preferred prop
  irn?: string;                          // legacy support
  onCloseAll?: (refresh?: boolean) => void; // keep signature consistent with others
}

const Form323ApprovedCompensationCalculationCPMReviewInjury: React.FC<
  Form323ApprovedCompensationCalculationCPMReviewInjuryProps
> = ({ IRN, irn, onCloseAll }) => {
  useAuth(); // not strictly needed here, but fine to keep if you later show user info
  ...
  const handleClose = () => onCloseAll?.(false); // no refresh needed for read-only viewer
          ...
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center gap-3">
              <h2 className="text-lg font-semibold text-gray-900">
                Compensation Calculation — CPM Review (Injury) — Approved
              </h2>
              {displayIRN && (
            ...
            <section className="border rounded-lg p-4">
              ...
              {resolvedIRN ? (
                ...
                <p className="text-gray-500">
                  Injury claim details cannot be loaded without a valid IRN.
                </p>
              )}
            </section>
...
export default Form323ApprovedCompensationCalculationCPMReviewInjury;
