...
import Form113View from './Form124iew';
...
const Form124CPOForm18DeathEmployerResponseReview: React.FC<InjuryReviewProps> = ({ 
  irn, 
  incidentType, 
  onClose, 
  onSubmit, 
    ...
    <div className="p-6">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Section 1: Form 124 - Death Claim Detail */}
          <div className="border rounded-lg p-4" id="injuryclaims-section">
            ...
            {irn ? (
              <Form124View irn={irn.toString()} onClose={onClose} />
            ) : (
...
export default Form124CPOForm18DeathEmployerResponseReview;
