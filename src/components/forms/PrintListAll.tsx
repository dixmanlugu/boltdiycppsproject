...
const PrintListAll: React.FC<PrintListAllProps> = ({ onClose }) => {
  ...
  const generatePDF = async () => {
    try {
      ...
      // Add title
      doc.setFontSize(14);
      doc.text('Office Of Workers Compensation - Tribunal Hearing Pending List', pageWidth / 2, 30, { align: 'center' });
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              This will generate a PDF report of all pending hearings (both public and private).
            </p>
