import React, { useState, useEffect } from 'react';
    ...
    const DecisionTimeBarredFormSubmissionRegistrarReview: React.FC = () => {
      ...
      const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
          // Update time-barred claims review table
      ...
      return (
        <div className="bg-surface p-8 rounded-lg shadow-md max-w-2xl mx-auto">
          <h1 className="text-3xl font-bold mb-6 text-primary">Time-Barred Claim Decision Review</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex space-x-4">
                ...
                <label className="flex items-center">
                  <input
                    ...
                    name="status"
                    value="OnHold"
                    checked={formData.status === 'OnHold'}
                    onChange={handleInputChange}
                    className="text-primary focus:ring-primary"
                  />
                  <span className="ml-2 text-textSecondary">On Hold</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    name="status"
                    value="ForwardToTribunal"
                    checked={formData.status === 'ForwardToTribunal'}
                    onChange={handleInputChange}
                    className="text-primary focus:ring-primary"
                  />
                  <span className="ml-2 text-textSecondary">Forward to Tribunal</span>
                </label>
              </div>
              {errors.status && (
            ...
            {formData.status === 'ForwardToTribunal' && (
              <div className="mb-4">
                <label htmlFor="hearing_type" className="block text-sm font-medium text-textSecondary">
                  Hearing Type
                </label>
                <select
                  id="hearing_type"
    ...
    export default DecisionTimeBarredFormSubmissionRegistrarReview;
