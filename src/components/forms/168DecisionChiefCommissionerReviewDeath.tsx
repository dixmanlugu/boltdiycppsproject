// /src/components/forms/168DecisionChiefCommimssionerReviewDeath.tsx
...
const Decision168ChiefCommissionerReviewDeath: React.FC<Props> = ({
  IRN,
  irn,
  onCloseAll,
}) => {
          ...
          <div className="p-6 space-y-8 overflow-y-auto">
            ...
            <section className="border rounded-lg p-4">
              ...
              {resolvedIRN ? (
                    <Form124View
      irn={resolvedIRN}
      variant="embedded"                      // 👈 renders inline, no backdrop/portal
      className="max-h-[60vh] overflow-auto"  // 👈 optional: keep this section scrollable
      onClose={handleClose}                   // optional; ignored in embedded mode
    />
              ) : (
...
export default Decision168ChiefCommissionerReviewDeath;
